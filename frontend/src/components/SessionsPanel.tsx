...
export default function SessionsPanel() {
  ...
  if (isLoading && !data) {
    return <Panel title={t('tabs.sessions')} className="col-span-full"><div className="glow text-[13px] animate-pulse">{t('loading')}</div></Panel>
  }
  ...
  return (
    <>
      ...
      <Panel title={t('sessions.recentSessions')}>
